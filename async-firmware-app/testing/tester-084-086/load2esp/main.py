...
left_led8 = machine.PWM(machine.Pin(13), freq=50)
right_led7 = machine.PWM(machine.Pin(15), freq=50)
...
def turnx(key):  # inverted for ginger, should be straight for trike and buggy
    ...
    move_servo(right_led7, duty=key, servo_adj_zero=-35, servo_multiply_power=8)
    move_servo(left_led8, duty=key, servo_adj_zero=-34, forward=False, servo_multiply_power=8)
