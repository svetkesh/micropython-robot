...
try:
    ...
    for i in range(0, n_factor * 1000):
        pass
    print(time.ticks_ms())
    ...
    print('MSG for command {}\n'
          'cycles {}\n'
          'run in {} s\n'
          'meantime: {} mks '.format('pass',
                                    i + 1,
                                    time.ticks_diff(time.ticks_ms(), start_timer) / 1000,
                                    time.ticks_diff(time.ticks_ms(), start_timer)/(n_factor * 1000)))
